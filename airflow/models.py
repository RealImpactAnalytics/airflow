...
class TaskInstance(Base):
    ...
    def are_dependencies_met(
        ...
        for trigger in self.task.triggers_from_the_past:
            triggered = trigger.evaluate(self.execution_date, main_session)[0]
        ...
        for trigger in self.task.triggers:
            evaluation = trigger.evaluate(self.execution_date, main_session)
...
class Trigger(object):
    ...
    * Trigger(t, [x, y]) depends on the state of t from the now-x schedule to
    ...
    def _states_by_schedule(self, execution_date, main_session=None):
        """
